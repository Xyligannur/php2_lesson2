...
<body>
    ...
    <form method="post">
        ...
        <br>
        <textarea name="short" class="form-control" placeholder="Краткое описание...." rows="5" cols="20"><?=$short?></textarea>
        <br>
        ...
        <button type="submit" value="Добавить" class="btn btn-primary">Добавить статью</button>
    </form>
    <hr>
